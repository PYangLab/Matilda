...
def rna_train(rna,cty,batch_size=64,epochs=30,lr=0.02,z_dim=100,hidden_rna=185,seed=1,augmentation=True):
    ...
    model = CiteAutoencoder(nfeatures_rna, hidden_rna, z_dim, classify_dim)
...
def run_matilda_rna_train():
    arguments = matilda_args_rna_train()
    rna_train(**arguments)
    
if __name__ == "__main__":
    run_matilda_rna_train()
