...
def rna_task(rna,cty,batch_size=64,z_dim=100,hidden_rna=185,seed=1,classification=False,query=False,fs=False,
...
def run_matilda_rna_task():
    arguments = matilda_args_rna_task()
    rna_task(**arguments)
    
if __name__ == "__main__":
    run_matilda_rna_task()
